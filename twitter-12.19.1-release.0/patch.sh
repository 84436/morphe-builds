...
PATCHES=(
  "Block update screen" # Blocks the 'This app is out of date' update screen from being shown on launch
  ...
  "Custom share menu" # Overrides existing share menu and adds a new one
  ...
  "More information on profile" # Adds more details on the profile page
  ...
  "Remove premium upsell" # Removes premium upsells
