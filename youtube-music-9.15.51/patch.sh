...
PATCHES=(
  ...
  "Play albums songs" # Adds an option to play the song version of album tracks instead of music videos.
  ...
  "Third-party lyrics" # Adds an option to show synced lyrics with experience enhancement from 15+ providers in the lyrics panel.
  ...
  # "Downloads" # Adds support to download songs using the in-app download button, either with an external downloader app or inside YouTube Music.
