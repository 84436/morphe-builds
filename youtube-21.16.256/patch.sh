...
PATCHES=(
  ...
  "Disable video codecs" # Adds options to disable or force HDR, and to disable VP9 codecs.
  ...
  "Navigation bar" # Adds options to hide and change the bottom navigation bar (such as the Shorts button) and the upper navigation toolbar.
