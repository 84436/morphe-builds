...
const TWITTER: PackageName = 'com.twitter.android'
const ALL_PACKAGES = null

const patchBundle: PatchBundle = await Bun.file("morphe.json").json();
// const patchBundle: PatchBundle = await Bun.file("piko.json").json();
